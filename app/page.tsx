...
export default function Home() {
  return (
    <main className="max-w-full min-h-screen bg-zinc-950 px-8 py-12">
      <span className="border-[1px] border-zinc-800 rounded-md p-3 text-sm text-zinc-200 font-bold cursor-default">
        FinancyDash
      </span>
      <section className="flex flex-col items-center justify-center h-screen">
        <div className="border-[1px] border-zinc-800 rounded-md p-8 text-zinc-200 w-[50%] text-center space-y-8">
