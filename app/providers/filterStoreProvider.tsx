...
import { type FiltersStore, createFiltersStore } from "../store/FiltersStore"

export type FiltersStoreApi = ReturnType<typeof createFiltersStore>

export const FiltersStoreContext = createContext<FiltersStoreApi | null>(null)

export interface FiltersStoreProviderProps {
  children: ReactNode
}

export const FiltersStoreProvider = ({ children }: FiltersStoreProviderProps) => {
...
export const useFiltersStore = <T,>(selector: (store: FiltersStore) => T,): T => {
